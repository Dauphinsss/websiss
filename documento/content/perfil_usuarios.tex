...
La Tabla~\ref{tab:perfil-encuestados} muestra una muestra relativamente equilibrada por sexo y con mayor concentración en estudiantes de semestres intermedios. El 72\% de los participantes pertenece a semestres 3 en adelante, mientras que el 28\% corresponde a ingresantes. Esta distribución resulta pertinente para el proyecto porque permite contrastar experiencias de primer contacto con experiencias de uso acumulado, identificando tanto dificultades de orientación inicial como estrategias de adaptación desarrolladas con el tiempo.
...
La Tabla~\ref{tab:dificultad-problemas} permite identificar un patrón consistente: la mayor dificultad no se concentra en la consulta de información, sino en la ejecución de tareas que requieren decisión y seguimiento del proceso. La inscripción a materias es percibida como neutral o difícil por el 76\% de los encuestados, y el 80\% declara haber necesitado ayuda externa al menos a veces. A esto se suma que el 56\% reporta no haber podido completar alguna tarea académica importante, lo que indica que los problemas de uso trascienden la incomodidad y llegan a tener consecuencias reales. En cuanto a los problemas más frecuentes, predominan los pasos no obvios (40\%) y la interfaz confusa (32\%), por encima de la lentitud del sistema (24\%), lo que sugiere que el problema central no es solo técnico, sino también estructural y de arquitectura de información. Esta lectura se refuerza con las mejoras priorizadas: la organización del menú (44\%) y la guía integrada (32\%) aparecen por encima de una demanda meramente estética.
