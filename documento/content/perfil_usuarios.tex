...
\subsection{Entrevistas: Guía y hallazgos}
...
\subsubsection{Guía de entrevista}
...
\paragraph{Bloque 1: Contexto y perfil}
\begin{itemize}
  \item ¿En qué carrera y semestre estás? ¿Trabajas además de estudiar?
  \item ¿Con qué frecuencia usas WebSIS y desde qué dispositivo?
  \item ¿Te considerarías una persona con buenas habilidades en tecnología?
\end{itemize}

\paragraph{Bloque 2: Experiencia general con WebSIS}
\begin{itemize}
  \item ¿Cuál fue tu primera experiencia usando WebSIS?
  \item ¿Qué tareas realizas con mayor frecuencia dentro del sistema?
  \item ¿Qué aspectos te resultan más claros y cuáles te generan mayor confusión?
  \item ¿Cómo describirías tu experiencia general con la plataforma?
\end{itemize}

\paragraph{Bloque 3: Inscripción a materias y momentos críticos}
\begin{itemize}
  \item Cuéntame tu proceso al inscribirte a materias, paso a paso.
  \item ¿Alguna vez tuviste un problema durante una inscripción? ¿Qué pasó y cómo lo resolviste?
  \item ¿Sueles hacerlo solo/a o pides ayuda? ¿A quién recurres?
  \item ¿Alguna vez se te venció el plazo o no pudiste inscribirte por dificultades con el sistema?
\end{itemize}

\paragraph{Bloque 4: Dimensión emocional (Design Thinking -- Fase de Empatía)}
\begin{itemize}
  \item ¿Cómo te sientes justo antes de ingresar a WebSIS en período de inscripciones?
  \item ¿Recuerdas alguna vez haberte sentido perdido/a o desesperado/a dentro del sistema? ¿Qué hiciste?
  \item ¿Cuánto confías en que lo que hiciste en el sistema quedó bien registrado?
  \item ¿Sientes que WebSIS te trata como alguien capaz de gestionar tus propios trámites, o sientes que el sistema te hace depender de otros?
  \item Si el sistema fuera una persona, ¿cómo la describirías?
\end{itemize}

\paragraph{Bloque 5: Expectativas y propuestas}
\begin{itemize}
  \item Si pudieras cambiar una sola cosa de WebSIS, ¿qué sería?
  \item ¿Hay alguna otra aplicación que uses y que te parezca más fácil? ¿Qué tiene de diferente?
  \item ¿Qué información o ayuda te hubiera gustado tener la primera vez que usaste WebSIS?
  \item ¿Considerarías útil una versión mejor para celular?
\end{itemize}

\subsubsection{Síntesis de las entrevistas}

A continuación se presenta un resumen de los hallazgos principales de cada entrevista, incluyendo la nueva columna de dimensión emocional derivada del bloque 4.
