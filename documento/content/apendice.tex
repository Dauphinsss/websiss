...
% ============================================================
\appendix
\section{Instrumento: Cuestionario WebSIS}\label{apx:cuestionario}

\subsubsection*{CUESTIONARIO -- Experiencia con el Sistema WebSIS}
...
\begin{itemize}
  \item \textbf{Sexo:} [ ] Femenino \quad [ ] Masculino \quad [ ] Prefiero no decir
...
\paragraph{Sección C: Dificultades y usabilidad}
\begin{itemize}
