...
Las necesidades detectadas no son una lista de funcionalidades ausentes: representan la traducción de lo que los usuarios dicen, piensan, sienten y hacen en requerimientos concretos que el rediseño debe atender. Estas necesidades fueron construidas a partir de la triangulación de cinco fuentes de información: el cuestionario aplicado a 25 estudiantes, la sección emocional del cuestionario (Sección D), las entrevistas semiestructuradas, las sesiones de observación directa y los mapas de empatía elaborados en la sección 4.6.

Desde la perspectiva del Design Thinking, estas necesidades representan la síntesis de la fase de empatía: traducen lo que los usuarios dicen, piensan, sienten y hacen en requerimientos concretos que deberá atender el rediseño. No se trata únicamente de funcionalidades ausentes, sino de brechas entre la experiencia actual del sistema y la experiencia que el estudiante necesita para gestionar su trayectoria académica con autonomía y confianza.
...
\begin{longtable}{|>{\bfseries}p{0.6cm}|p{2.1cm}|p{3.1cm}|p{3.1cm}|p{3.6cm}|}
\hline
