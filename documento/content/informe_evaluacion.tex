...
\begin{figure}[H]
  ...
  \caption{P-03 corregido: la inscripción detecta el choque de horarios entre dos materias antes de finalizar y permite revisar grupos o asumir el conflicto explícitamente.}
  \label{fig:fix-conflicto}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.22\textheight,keepaspectratio]{images/prototipo/13-estado-materia.png}
  \caption{P-01: El contraste del estado de matrícula usa fondo sólido y texto alto contraste.}
  \label{fig:fix-estado-matricula}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{images/prototipo/08-kardex.png}
  \caption{P-02: El Kardex incorpora una leyenda de las abreviaturas de estado en la tabla.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.22\textheight,keepaspectratio]{images/prototipo/12-retiro-confirmacion.png}
  \caption{Confirmación explícita antes de retirar una materia de la inscripción.}
  \label{fig:fix-retiro}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{images/prototipo/11-estado-vacio.png}
  \caption{Estado vacío del módulo de inscripción, con mensaje orientativo.}
  \label{fig:fix-vacio}
\end{figure}
